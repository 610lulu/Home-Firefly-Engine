...
PREVIEW_LIGHTS = _int_env("FIREFLY_PREVIEW_LIGHTS", 120)
PREVIEW_LAYOUT_FILE = os.getenv("FIREFLY_PREVIEW_LAYOUT", "")
PREVIEW_BACKGROUND_IMAGE = os.getenv("FIREFLY_PREVIEW_BACKGROUND", "")
PREVIEW_SHOW_LABELS = os.getenv("FIREFLY_PREVIEW_LABELS", "0") == "1"

MAX_PRESENCE_POINTS = _int_env("FIREFLY_MAX_PRESENCE_POINTS", 6)
PRESENCE_RADIUS = _float_env("FIREFLY_PRESENCE_RADIUS", 0.22)
PRESENCE_TIMEOUT_SECONDS = _float_env("FIREFLY_PRESENCE_TIMEOUT", 3.0)
IDLE_BRIGHTNESS = _float_env("FIREFLY_IDLE_BRIGHTNESS", 0.012)
